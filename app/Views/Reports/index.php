...
<style>
    ...
    .glass-card { background: rgba(255,255,255,0.85); backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.4); border-radius: 20px; box-shadow: 0 6px 24px rgba(31,38,135,0.06); transition: transform .2s, box-shadow .2s; }
    ...
    select.period-select { border-radius: 12px; border: 1px solid #e5e7ff; padding: 8px 16px; font-weight: 600; color: #5D5FEF; background: #f0f0ff; cursor: pointer; }
