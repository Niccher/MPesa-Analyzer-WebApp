...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 8rem; font-weight: 800; background: linear-gradient(135deg, #FF7F50 0%, #FF6347 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        ...
        .illustration { font-size: 5rem; color: #FF7F50; margin-bottom: 1rem; }
    </style>
</head>
<body>
    <div class="error-card">
        <div class="illustration"><i class="fa-solid fa-hand fa-shake"></i></div>
        <div class="error-code">403</div>
        <h1 class="error-title">Access Forbidden</h1>
        <p class="error-message">You found the gate, but you don't have the key. Access to this resource is strictly restricted.</p>
        <div class="d-grid gap-2"><a href="/" class="btn btn-primary btn-lg">Back to Safety</a></div>
    </div>
</body>
</html>
