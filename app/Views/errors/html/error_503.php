...
<head>
    ...
    <style>
        ...
        .error-code { font-size: 8rem; font-weight: 800; background: linear-gradient(135deg, #70A1FF 0%, #1E90FF 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
        ...
        .illustration { font-size: 5rem; color: #70A1FF; margin-bottom: 1rem; }
    </style>
</head>
<body>
    <div class="error-card">
        <div class="illustration"><i class="fa-solid fa-screwdriver-wrench fa-bounce"></i></div>
        <div class="error-code">503</div>
        <h1 class="error-title">Brief Pause</h1>
        <p class="error-message">We're performing some maintenance to make the analyzer even better. We'll be back in just a moment!</p>
        <div class="d-grid gap-2"><button onclick="location.reload()" class="btn btn-primary btn-lg">Check Again</button></div>
    </div>
</body>
</html>
